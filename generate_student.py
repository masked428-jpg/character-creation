...
FIRST_NAMES_BLUEARCHIVE = {
    "生徒": [
        ...
        "マヨ",
        "アン", "エマ", "オトエ", "カオリ", "キミコ", "ケイコ", "ココア", "シオ", "スミコ", "ヒロコ", "マサコ",
        "アリサ",
        "ミチコ", "ミナミ", "ミホ", "ユウ", "ユマ", "リイサ", "アイ", "アオナ", "アキカ", "アコウ", "アスカ", "アマネ",
        "アミ", "カオルコ", "アヤカ", "アユナ", "アリ", "アルル", "アンナ", "イオ", "イクコ", "イノリ", "ウタウ",
        "ウタネ",
        "ウレシ", "エオリ", "エカ", "エツカ", "エミコ", "エリイ", "エリホ", "オトカ", "オトミ", "オリネ", "カズヨ",
        "カノ",
        "カセン", "アモ", "カツコ", "カナミ", "カノリ", "カハ", "カホノ", "カホリ", "カユコ", "キアメ", "キエコ",
        "キミ",
        "キエミ", "キオコ", "キスミ", "キヒロ", "キユキ", "キョウ", "キラエ", "キルイ", "クイ", "クニエ", "クミ",
        "クモ",
        "ケイカ", "コア", "コウミ", "ココミ", "コスズ", "コハク", "コマチ", "コユウ", "サカ", "サキカ", "サキネ",
        "サチコ",
        "サトミ", "サヤカ", "サヤノ", "サヨリ", "シアヤ", "シゲコ", "シズカ", "シトカ", "シノ", "シノル", "ジユウ",
        "シユキ",
        "シュンリ", "ジン", "スズエ", "スズノ", "スズメ", "スバル", "スリカ", "セイコ", "セツキ", "ソウア", "ソウカ",
        "タホ",
        "ソリン", "タエコ", "タカコ", "タクエ", "タマミ", "タマリ", "チカ", "チカエ", "チカコ", "ツグハ", "テルコ",
        "テルノ",
        "チヨ", "テル", "トウカ", "トキコ", "トトミ", "トモコ", "トヨ", "ナキ", "ナコ", "ナツキ", "ナヅキ", "ナナ",
        "ナユ",
        "ナナコ", "ナリミ", "ナルカ", "ナルキ", "ニツル", "ネナ", "ノジコ", "ノブエ", "ノブカ", "ノブコ", "ノラン",
        "ノリエ",
        "ノリコ", "ハアイ", "ハズエ", "ハヤカ", "ハユカ", "ヒア", "ヒサナ", "ヒソラ", "ヒトミ", "ヒナノ", "ヒビセ",
        "ヒロミ",
        "ヒヨ", "フキノ", "フクヨ", "フサコ", "フミカ", "フラワ", "マウル", "マカナ", "マキビ", "マツノ", "マナミ",
        "マミ",
        "マモル", "マヤカ", "マユコ", "マリカ", "マワカ", "ミイ", "ミイト", "ミイナ", "ミエコ", "ミオ", "ミキア",
        "ミキヤ",
        "ミサエ", "ミサト", "ミシャ", "ミズキ", "ミツコ", "ミナエ", "ミナセ", "ミハル", "ミフミ", "ミマ", "ミユア",
        "ミュウ",
        "ミラ", "ミリア", "ミロ", "ムクノ", "ムル", "メグモ", "メグル", "メバエ", "メハナ", "モイ", "モネカ", "ユナ",
        "ユキ",
        "メルア", "ヤスコ", "ユアイ", "ユキコ", "ユキネ", "ユナギ", "ユララ", "ユリナ", "ヨウナ", "ヨシコ", "リカ",
        "リマホ",
        "リコ", "リナ", "リム", "リヨナ", "リンカ", "リンク", "リンネ", "リンリ", "ルラ", "ルリ", "ルリセ", "レイア",
        "レウ",
